...
export class RestaurantService {
  ...
  public async getRestaurants(
    params: GetRestaurants.QueryParams,
    ...
    return await this.restaurantRepository
      .getRestaurants(params.limit, params.offset, day, time, params.name)
      .getManyAndCount();
  }
   ...
   */
  public async getTopRestaurants(
    params: GetTopRestaurants.QueryParams,
  ): Promise<Restaurant[]> {
