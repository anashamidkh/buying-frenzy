...
export class SeedingRestaurantsData1660473036753 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        const data = JSON.parse(readFileSync("./src/data/restaurant_with_menu.json").toString());
        ...
        for (let k = 0; k < data.length; k++) {
            ...
            operationalSchedule = [...operationalSchedule,...operationalScheduleService.parseOperationalSchedule(data[k].openingHours, restaurants[k].id)];
        }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER SEQUENCE "operational_schedule_id_seq" RESTART WITH 1`);
        ...
        await queryRunner.query(`ALTER SEQUENCE "restaurant_id_seq" RESTART WITH 1`);
    }
